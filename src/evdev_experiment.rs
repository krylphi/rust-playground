...
fn new_kb_event(direction: MoveDirection, distance: u16) -> InputEvent {
    InputEvent::new_now(EventType::KEY, Key::KEY_LEFTCTRL.code(), 1); // 1 pressed

    InputEvent::new_now(EventType::KEY, Key::KEY_LEFTCTRL.code(), 0) // 0 released
}